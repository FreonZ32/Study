...
template<typename T>
void Aout(T arr[][C], int R, int C);

template<typename T>
double Sum(T arr[][C], int R, int C);

template<typename T>
double Avg(T arr[][C], int R, int C);

template<typename T>
int maxValueIn(T arr[][C], int R, int C);

template<typename T>
int minValueIn(T arr[][C], int R, int C);

template<typename T>
int ShiftLeft(T arr[][C], int m, int R, int C);

template<typename T>
int ShiftRight(T arr[][C], int m, int R, int C);


template<typename T>
int Sort(T arr[][C], int R, int C);

template<typename T>
int SortByShell(T arr[][C], int R, int C);
